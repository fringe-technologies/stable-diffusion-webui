...
from extensions-builtin.HAT.timm.helpers import to_2tuple
from extensions-builtin.HAT.timm.weight_init import trunc_normal_
...
if __name__ == '__main__':
    ...
    model = HAT(upscale=2, img_size=(height, width),
